...
func main() {
	...
	fmt.Println("Average Bandwidth Usage",dash.AverageBandwidth())
	fmt.Println("Average Cpu temp", dash.AverageCpuTemp())
	fmt.Println("Average Memory Usage",dash.AverageMemoryUsage())
}
